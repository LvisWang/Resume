    ...
    return (
        <div className='divWithPadding'>
            <h3> Ethereum Foundation | <a href="/pdf/AA.pdf" target="_blank" rel="noopener noreferrer" style={{ color: '#004080', textDecoration: 'underline' }}>Account Abstraction Report </a> |
                 <a href="https://dune.com/sixdegree/account-abstraction-overview" target="_blank" rel="noopener noreferrer" style={{color: '#004080',  textDecoration: 'underline' }}> Dashboard</a> | <a href="https://x.com/erc4337/status/1705836041444143365?s=20" target="_blank" rel="noopener noreferrer" style={{color: '#004080',  textDecoration: 'underline' }}>Feedback</a>
            </h3> 
